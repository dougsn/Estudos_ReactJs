...
class App extends Component {
  ...
  componentDidMount() {
    // Depois que o componente é montado, ele roda o que está dentro dele, como consumir uma API.

    setInterval(() => {
      this.setState({ hora: new Date().toLocaleTimeString() });
    }, 1000); // Foi feita um atraso de 1 segundo para podermos ver a montagem do componente e depois disso o bloco de código que está no DidMount é realizado.
  }

  componentDidUpdate() { // Depois que um componente é atualizado, ele roda o bloco de código que está dentro dele.
